...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('./urbit/app/orbis/css'));
});
...
gulp.task('js-imports', function(cb) {
  return gulp.src('dist/index.js')
    ...
    .pipe(gulp.dest('./urbit/app/orbis/js/'))
    .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('./urbit/app/orbis/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/orbis/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('./urbit/app/orbis/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/orbis/js/'));
});
